...
import static com.sun.xml.internal.ws.api.streaming.XMLStreamWriterFactory.get;
...
public class AJLabelLink extends JFrame {
...
private static class LinkMouseListener extends MouseAdapter {
    ...
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        ...
        try {
            URI uri = new java.net.URI(AJLabelLink.getPlainLink(l.getText()));
...
public static void main(String[] args) {
    SwingUtilities.invokeLater(new Runnable() {
        ...
        @Override
        public void run() {
            new AJLabelLink().setVisible(true);
        }
    });
}
}