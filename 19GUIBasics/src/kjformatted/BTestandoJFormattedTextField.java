...
public class BTestandoJFormattedTextField extends JFrame {

    private static final long serialVersionUID = 1L;

    public static void main(String[] args) {
        BTestandoJFormattedTextField field = new BTestandoJFormattedTextField();
    ...
    private void testaJFormattedTextField() {
        ...
        //mascaraTel.install(jFormattedTextTel); alternativo
