...
public class CRUDCidade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboUF.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MG", "RJ", "SP", "ES" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //poderia fazer um método para ADICIONAR e um para EDITAR
        //o conteúdo do if else seria modiicado
        Cidade inserida = this.cidadeDAORAM.salvar(c);//insert or update no BANCO
        if (codigo == null) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       this.cidadeDAORAM.remover(removida); //remove do BANCO
       this.tableModelCidade.remove(linhaSelecionada); //remove da TABELA
       this.limpa();
